...
import scienceExhibitionPoster from '../../assets/scienceExhibition.png';
...
const ScienceExhibition = () => {
  ...
  const event = {
    ...
    category: "Exhibition",                 
    poster: scienceExhibitionPoster, // Replace with your actual poster path
    description: "Dive into a world where imagination meets innovation! Our Science Exhibition showcases cutting-edge projects, creative prototypes, and mind-bending ideas brought to life by brilliant young minds. Explore models, experiments, and real-world tech solutions that define the future of science and engineering.",
    rules: [
      "Team size: 3 members ",
    ...
    googleFormLink: "https://docs.google.com/forms/d/e/1FAIpQLSf6F7IMYc550YTZA5VkjHIL53K_ID0EtI_QSFY2LB21l4Dvrw/viewform",
    leaderboardLink: "",
