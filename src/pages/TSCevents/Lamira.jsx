...
import lamiraPoster from '../../assets/lamira.png';
...
const Lamira = () => {
  ...
  const event = {
    title: "LA MIRA",
    category: "Adventure",
    poster: lamiraPoster, // Replace with your actual poster path
    ...
    googleFormLink: "https://forms.gle/dYRPd3XLuAc6rcvg7",
    leaderboardLink: " ",
